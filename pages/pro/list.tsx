...
const ListPage = () => {
  ...
  return (
    ...
    <Layout>
        ...
        <div className='w-full h-auto grid grid-cols-1 md:grid-cols-2 pt-20 md:pt-24 pb-10 md:pb-0 items-center overflow-hidden bg-gray-200'>
            <div className='w-5/6 md:w-7/12 mx-auto'>
                ...
                <div className='mt-5 md:mt-3 bg-white shadow-md rounded-md p-5'>
                    ...
                    <div className='p-inputgroup mt-3'>
                        ...
                        <input type="text" className='w-full p-inputtext rounded-l-none text-sm md:text-base' placeholder='e.g. Hull Cleaning' />
                    </div>
                    <div className='p-inputgroup mt-2'>
                        <span className="p-inputgroup-addon bg-white border-r-0">
                            <i className="pi pi-map-marker text-[#109EDA] text-sm font-bold"></i>
                        </span>
                        <input type="text" className='w-full p-inputtext rounded-l-none text-sm md:text-base' placeholder='Tampa, Florida' />
                    </div>
                    <div className='w-full mt-5'>
                        <Link href={'/pro/form-1'} className='flex justify-center items-center py-2 rounded-md w-full bg-[#373A85] text-white text-sm md:text-base font-medium hover:bg-[#2a2c64]'>Get Started</Link>
                    </div>
                </div>
