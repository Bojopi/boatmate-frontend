...
import { formatDate, formatDateDash } from '@/functions/date';
...
const InboxPage = () => {
  ...
  const activeInbox = (index: number) => {
  ...
  return (
    <div className='relative overflow-hidden'>
      <LayoutPrincipal>
          ...
          <Toast ref={toast} />
          <p className='w-full md:w-[60%] mx-auto font-semibold'>Inbox</p>
          <div className="w-[500px] h-[500px] left-[80%] top-[300px] absolute bg-sky-500/30 rounded-full blur-3xl -z-10" />
          <div className='w-[60%] h-full mx-auto mt-8 flex gap-5'>
            ...
            <div className='h-auto w-full border rounded-xl bg-white'>
