            ...
            <SideBarComponent>
                {
                    index === 0 ?
                        <ul>
                            <li className={`w-full px-5 py-3 border-b cursor-pointer text-gray-500 font-medium hover:text-black hover:underline hover:underline-offset-4 side-item ${sideItem === 0 ? 'active-side-item' : null}`} onClick={activeSideItem} id='profile'>Profile</li>
                        </ul>
                    : index === 1 ?
                        <ul>
                            <li className={`w-full px-5 py-3 border-b cursor-pointer text-gray-500 font-medium hover:text-black hover:underline hover:underline-offset-4 side-item ${sideItem === 0 ? 'active-side-item' : null}`} onClick={activeSideItem} id='users'>Users</li>
                    ...
                    : index === 2 ?
                        <ul>
                            <li className={`w-full px-5 py-3 border-b cursor-pointer text-gray-500 font-medium hover:text-black hover:underline hover:underline-offset-4 side-item ${sideItem === 0 ? 'active-side-item' : null}`} onClick={activeSideItem} id='providers'>Providers</li>
                    ...
                    : index === 3 ?
                        <ul>
                            <li className={`w-full px-5 py-3 border-b cursor-pointer text-gray-500 font-medium hover:text-black hover:underline hover:underline-offset-4 side-item ${sideItem === 0 ? 'active-side-item' : null}`} onClick={activeSideItem} id='boats'>Boats</li>
                        </ul>
                    : null
                }
            </SideBarComponent>
